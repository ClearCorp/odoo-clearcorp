...
class ProjectNameShortcut(osv.osv):
        ...
        for project in self.browse(cr, uid, ids, context=context):
            if project.id not in done_ids:
                ...
                while proj and proj.parent_id:
                    if proj.code != '' and proj.code is not False:
    ...
    def name_search(self, cr, uid, name='', args=None,
        ...
        analytic_account_ids = [
            project.analytic_account_id.id for
            project in self.browse(cr, uid, ids, context=context)]

        analytic_account_ids = self.pool.\
            get('account.analytic.account').\
            get_children(cr, uid, analytic_account_ids, context=context)
...
class AccountNameShortcut(osv.osv):

...
class account_invoice_line_ccorp(models.Model):
    '''
    ...
    price_subtotal_not_discounted = fields.Float(compute='_compute_amount_line_no_discount', string='Subtotal')
...
class account_invoice_ccorp(models.Model):
    ...
    def _compute_amount_all(self):
        for invoice in self:
            ...
            invoice.amount_untaxed_not_discounted = amount_untaxed_not_discounted
